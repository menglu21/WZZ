...
#        wlv_v4=w_v4(wl_v4, met_user, met_phi_user)
    ...
    if (len(TFMuons_id)+len(TFElectrons_id))==5:
      ...
      if len(TFMuons_id)==5:
        ...
        SR5L_dR_z1l1z1l2=z1l1_v4.DeltaR(z1l2_v4)
        SR5L_dR_z1l1z2l1=z1l1_v4.DeltaR(z2l1_v4)
        SR5L_dR_z1l1z2l2=z1l1_v4.DeltaR(z2l2_v4)
        SR5L_dR_z1l1wl=z1l1_v4.DeltaR(l5_v4)
        SR5L_dR_z1l2z2l1=z1l2_v4.DeltaR(z2l1_v4)
        SR5L_dR_z1l2z2l2=z1l2_v4.DeltaR(z2l2_v4)
        SR5L_dR_z1l2wl=z1l2_v4.DeltaR(l5_v4)
        SR5L_dR_z2l1z2l2=z2l1_v4.DeltaR(z2l2_v4)
        SR5L_dR_z2l1wl=z2l1_v4.DeltaR(l5_v4)
        SR5L_dR_z2l2wl=z2l2_v4.DeltaR(l5_v4)
        ...
        SR5L_dR_z1l1z1l2=z1l1_v4.DeltaR(z1l2_v4)
        SR5L_dR_z1l1z2l1=z1l1_v4.DeltaR(l4_v4)
        SR5L_dR_z1l1z2l2=z1l1_v4.DeltaR(l5_v4)
        SR5L_dR_z1l1wl=z1l1_v4.DeltaR(wl_v4)
        SR5L_dR_z1l2z2l1=z1l2_v4.DeltaR(l4_v4)
        SR5L_dR_z1l2z2l2=z1l2_v4.DeltaR(l5_v4)
        SR5L_dR_z1l2wl=z1l2_v4.DeltaR(wl_v4)
        SR5L_dR_z2l1z2l2=l4_v4.DeltaR(l5_v4)
        SR5L_dR_z2l1wl=l4_v4.DeltaR(wl_v4)
        SR5L_dR_z2l2wl=l5_v4.DeltaR(wl_v4)
        ...
        SR5L_dR_z1l1z2l1=l1_v4.DeltaR(z2l1_v4)
        SR5L_dR_z1l1z2l2=l1_v4.DeltaR(z2l2_v4)
        SR5L_dR_z1l1wl=l1_v4.DeltaR(wl_v4)
        SR5L_dR_z1l2z2l1=l2_v4.DeltaR(z2l1_v4)
        SR5L_dR_z1l2z2l2=l2_v4.DeltaR(z2l2_v4)
        SR5L_dR_z1l2wl=l2_v4.DeltaR(wl_v4)
        SR5L_dR_z2l1z2l2=z2l1_v4.DeltaR(z2l2_v4)
        SR5L_dR_z2l1wl=z2l1_v4.DeltaR(wl_v4)
        SR5L_dR_z2l2wl=z2l2_v4.DeltaR(wl_v4)
